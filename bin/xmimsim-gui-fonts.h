...
//Windows 32/64
	...
	#define RESULTS_PLOT_LABELS_LR_EXP 12
	#define RESULTS_PLOT_LABELS_TP 20

	#define TUBE_PLOT_TITLE 25
	#define TUBE_PLOT_LABELS_LR_FLOAT 20
	#define TUBE_PLOT_LABELS_LR_EXP 12
	#define TUBE_PLOT_LABELS_TP 20

	#define BATCH_2D_PLOT_TITLE 22
	#define BATCH_2D_PLOT_LABELS_LR_FLOAT 18
	#define BATCH_2D_PLOT_LABELS_LR_EXP 12
	#define BATCH_2D_PLOT_LABELS_TB_FLOAT 18
	#define BATCH_2D_PLOT_LABELS_TB_EXP 12

	#define BATCH_3D_PLOT_TITLE 22
	#define BATCH_3D_PLOT_LABELS_LR_FLOAT 18
	#define BATCH_3D_PLOT_LABELS_LR_EXP 12
	#define BATCH_3D_PLOT_LABELS_TB_FLOAT 18
	#define BATCH_3D_PLOT_LABELS_TB_EXP 12
